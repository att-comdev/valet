...
from allegro.compute.pollsters import disk
from allegro.compute.virt import inspector as virt_inspector
import allegro.tests.base as base
...
class TestBaseDiskIO(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        patch_virt = mockpatch.Patch(
            'allegro.compute.virt.inspector.get_hypervisor_inspector',
        ...
        patch_inspector = mockpatch.Patch(
            'allegro.compute.pollsters.BaseComputePollster.inspector',
            self.inspector)
