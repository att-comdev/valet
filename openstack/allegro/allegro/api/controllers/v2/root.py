...
from allegro.api.controllers.v2 import alarms
from allegro.api.controllers.v2 import capabilities
from allegro.api.controllers.v2 import events
from allegro.api.controllers.v2 import meters
from allegro.api.controllers.v2 import query
from allegro.api.controllers.v2 import resources
from allegro.api.controllers.v2 import samples
from allegro.i18n import _LW
...
cfg.CONF.import_opt('dispatcher', 'allegro.dispatcher')
        ...
        if self._gnocchi_is_enabled is None:
            if cfg.CONF.api.gnocchi_is_enabled is not None:
                ...
                try:
                    ...
                    LOG.warn(_LW("allegro-api started with gnocchi "
        ...
        if self._aodh_url is None:
            if cfg.CONF.api.aodh_is_enabled is False:
                ...
                try:
                    ...
                    LOG.warn(_LW("allegro-api started with aodh enabled. "
