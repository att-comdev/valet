...
# under the License.
"""Tests for valet/central/manager.py
"""
...
from valet.agent import manager
from valet.agent import plugin_base
from valet.hardware import discovery
from valet import pipeline
from valet.tests.unit.agent import agentbase
...
@mock.patch('valet.compute.pollsters.'
            'BaseComputePollster.setup_environment',
            mock.Mock(return_value=None))
class TestManager(base.BaseTestCase):

    @mock.patch('valet.pipeline.setup_polling', mock.MagicMock())
    ...
    @mock.patch('valet.ipmi.pollsters.node._Base.__init__',
                mock.Mock(return_value=None))
    @mock.patch('valet.ipmi.pollsters.sensor.SensorPollster.__init__',
                mock.Mock(return_value=None))
    ...
    @mock.patch('valet.ipmi.pollsters.sensor.SensorPollster.__init__',
                mock.Mock(return_value=None))
    @mock.patch('valet.agent.manager.LOG')
...
class TestRunTasks(agentbase.BaseAgentManagerTestCase):
    ...
    @mock.patch('valet.agent.manager.LOG')
    @mock.patch('valet.nova_client.LOG')
