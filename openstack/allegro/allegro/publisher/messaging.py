...
from allegro.i18n import _, _LE
...
RPC_OPTS = [
    cfg.StrOpt('metering_topic',
               ...
               help='The topic that allegro uses for metering messages.',
...
NOTIFIER_OPTS = [
    cfg.StrOpt('metering_topic',
               default='metering',
               help='The topic that allegro uses for metering '
               'notifications.',
               ),
    cfg.StrOpt('event_topic',
               default='event',
               help='The topic that allegro uses for event '
               'notifications.',
               ),
    cfg.StrOpt('telemetry_driver',
               default='messagingv2',
               help='The driver that allegro uses for metering '
               'notifications.',
...
cfg.CONF.import_opt('host', 'allegro.service')
