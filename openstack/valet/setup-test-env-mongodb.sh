...
export VALET_TEST_MONGODB_URL="mongodb://localhost:${MONGO_PORT}/valet"
if test -n "$VALET_TEST_HBASE_URL"
then
    export VALET_TEST_HBASE_TABLE_PREFIX=$(hexdump -n 16 -v -e '/1 "%02X"' /dev/urandom)
