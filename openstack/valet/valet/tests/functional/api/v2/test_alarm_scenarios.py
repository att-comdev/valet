...
from valet.tests.functional.api import v2
...
class TestAlarms(v2.FunctionalTest,
    ...
    def test_post_alarm_trust(self):
        ...
        with mock.patch('valet.keystone_client.get_v3_client') as client:
    ...
    @mock.patch('valet.keystone_client.get_client')
