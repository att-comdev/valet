...
from allegro.dispatcher import gnocchi
from allegro import service as allegro_service
...
class DispatcherTest(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        allegro_service.prepare_service(argv=[], config_files=[])
        self.conf.config(
            resources_definition_file=self.path_get(
                'etc/allegro/gnocchi_resources.yaml'),
        ...
        self.useFixture(mockpatch.Patch(
            'allegro.keystone_client.get_client',
    ...
    @mock.patch('allegro.dispatcher.gnocchi.GnocchiDispatcher'
                '._process_resource')
...
class DispatcherWorkflowTest(base.BaseTestCase,
    ...
    @mock.patch('allegro.dispatcher.gnocchi.LOG')
    @mock.patch('allegro.dispatcher.gnocchi_client.LOG')
    @mock.patch('allegro.dispatcher.gnocchi_client.requests')
