...
from allegro.network.statistics.opendaylight import driver
...
class _Base(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.get_flow_statistics = mock.patch(
            'allegro.network.statistics.opendaylight.client.'
            'StatisticsAPIClient.get_flow_statistics',
            return_value=self.flow_data).start()

        mock.patch('allegro.network.statistics.opendaylight.client.'
