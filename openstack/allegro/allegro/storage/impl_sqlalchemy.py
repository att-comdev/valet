...
from allegro.storage import models as api_models
from allegro.storage.sqlalchemy import models
from allegro.storage.sqlalchemy import utils as sql_utils
        ...
        if groupby:
            for group in groupby:
                if group not in ['user_id', 'project_id', 'resource_id',
                    ...
                    raise allegro.NotImplementedError('Unable to group by '
                                                         'these fields')
