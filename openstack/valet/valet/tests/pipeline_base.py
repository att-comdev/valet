...
from valet import publisher
from valet.publisher import test as test_publisher
from valet import sample
from valet import transformer
from valet.transformer import accumulator
from valet.transformer import arithmetic
from valet.transformer import conversions
...
class BasePipelineTestCase(base.BaseTestCase):
    ...
    @mock.patch('valet.transformer.conversions.LOG')
