...
class Connection(object):
    ...
    def get_resources(user=None, project=None, source=None,
        ...
        """
        raise allegro.NotImplementedError('Resources not implemented')
    ...
    def get_meters(user=None, project=None, resource=None, source=None,
        ...
        :param limit: Maximum number of results to return.
        """
        raise allegro.NotImplementedError('Meters not implemented')
    ...
    def get_samples(sample_filter, limit=None):
        ...
        :param limit: Maximum number of results to return.
        """
        raise allegro.NotImplementedError('Samples not implemented')
    ...
    def get_meter_statistics(sample_filter, period=None, groupby=None,
        ...
        """
        raise allegro.NotImplementedError('Statistics not implemented')
    ...
    def query_samples(filter_expr=None, orderby=None, limit=None):
        ...
        raise allegro.NotImplementedError('Complex query for samples '
                                             'is not implemented.')
