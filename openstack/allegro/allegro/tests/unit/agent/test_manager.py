...
# under the License.
"""Tests for allegro/central/manager.py
"""
...
from allegro.agent import manager
from allegro.agent import plugin_base
from allegro.hardware import discovery
from allegro import pipeline
from allegro.tests.unit.agent import agentbase
...
@mock.patch('allegro.compute.pollsters.'
            'BaseComputePollster.setup_environment',
            mock.Mock(return_value=None))
class TestManager(base.BaseTestCase):

    @mock.patch('allegro.pipeline.setup_polling', mock.MagicMock())
    ...
    @mock.patch('allegro.ipmi.pollsters.node._Base.__init__',
                mock.Mock(return_value=None))
    @mock.patch('allegro.ipmi.pollsters.sensor.SensorPollster.__init__',
                mock.Mock(return_value=None))
    ...
    @mock.patch('allegro.ipmi.pollsters.sensor.SensorPollster.__init__',
                mock.Mock(return_value=None))
    @mock.patch('allegro.agent.manager.LOG')
...
class TestRunTasks(agentbase.BaseAgentManagerTestCase):
    ...
    @mock.patch('allegro.agent.manager.LOG')
    @mock.patch('allegro.nova_client.LOG')
