...
from valet.dispatcher import gnocchi
from valet import service as valet_service
...
class DispatcherTest(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        valet_service.prepare_service(argv=[], config_files=[])
        self.conf.config(
            resources_definition_file=self.path_get(
                'etc/valet/gnocchi_resources.yaml'),
        ...
        self.useFixture(mockpatch.Patch(
            'valet.keystone_client.get_client',
    ...
    @mock.patch('valet.dispatcher.gnocchi.GnocchiDispatcher'
                '._process_resource')
...
class DispatcherWorkflowTest(base.BaseTestCase,
    ...
    @mock.patch('valet.dispatcher.gnocchi.LOG')
    @mock.patch('valet.dispatcher.gnocchi_client.LOG')
    @mock.patch('valet.dispatcher.gnocchi_client.requests')
