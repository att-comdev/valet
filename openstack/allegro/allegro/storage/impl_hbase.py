...
import allegro
from allegro.storage import base
from allegro.storage.hbase import base as hbase_base
from allegro.storage.hbase import migration as hbase_migration
from allegro.storage.hbase import utils as hbase_utils
from allegro.storage import models
...
class Connection(hbase_base.Connection, base.Connection):
    ...
    def record_metering_data(self, data):
        ...
        :param data: a dictionary such as returned by
          allegro.meter.meter_message_from_counter
        """
        with self.conn_pool.connection() as conn:
    ...
    def get_meters(self, user=None, project=None, resource=None, source=None,
        ...
        with self.conn_pool.connection() as conn:
            ...
            # https://bugs.launchpad.net/allegro/+bug/1301371
            result = set()
    ...
    def get_meter_statistics(self, sample_filter, period=None, groupby=None,
        ...
        """
        if groupby:
            raise allegro.NotImplementedError("Group by not implemented.")

        if aggregate:
            raise allegro.NotImplementedError(
