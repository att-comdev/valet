...
from allegro.alarm import service
...
class TestAlarmNotifier(tests_base.BaseTestCase):
    ...
    def test_notify_alarm(self):
        ...
        notifications = allegro_alarm.NOTIFIERS['test'].obj.notifications
    ...
    def test_notify_alarm_rest_action_with_ssl_verify_disable(self):
        action = 'https://host/action?allegro-alarm-ssl-verify=0'
    ...
    def test_notify_alarm_rest_action_with_ssl_verify_enable_by_user(self):
        action = 'https://host/action?allegro-alarm-ssl-verify=1'
    ...
    def test_notify_alarm_invalid_url(self):
        with mock.patch('oslo_utils.netutils.urlsplit',
                        self._fake_urlsplit):
            LOG = mock.MagicMock()
            with mock.patch('allegro.alarm.service.LOG', LOG):
