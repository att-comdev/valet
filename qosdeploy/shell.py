...
from qosdeploy.common import utils as qosdeploy_utils
from qosdeploy.qosorch import heat as heat_utils

#
# dict = utils.yaml.load(string)
# string = utils.yaml.dump(dict))
# dict = simplejson.loads(string)
# string = simplejson.dumps(dict)
#
...
class QoSDeployShell(object):
    ...
    def get_base_parser(self):
        ...
        parser = argparse.ArgumentParser(
            ...
            epilog='See "qosdeploy help COMMAND" '
    ...
    def get_subcommand_parser(self, version):
        ...
        submodule = qosdeploy_utils.import_versioned_module(version, 'shell')
    ...
    def main(self, argv):
        ...
        heat = heat_utils.Heat()

        args.func(heat, client, args)
...
def main(args=None):
    ''' CloudQoS Deployment for OpenStack Heat '''
    try:
        if args is None:
            args = sys.argv[1:]

        QoSDeployShell().main(args)
