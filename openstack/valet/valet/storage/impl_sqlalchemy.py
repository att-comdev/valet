...
from valet.storage import models as api_models
from valet.storage.sqlalchemy import models
from valet.storage.sqlalchemy import utils as sql_utils
        ...
        if groupby:
            for group in groupby:
                if group not in ['user_id', 'project_id', 'resource_id',
                    ...
                    raise valet.NotImplementedError('Unable to group by '
                                                         'these fields')
