...
# under the License.
"""Tests for allegro/storage/impl_hbase.py

.. note::
  In order to run the tests against real HBase server set the environment
  variable ALLEGRO_TEST_HBASE_URL to point to that HBase instance before
...
from allegro.alarm.storage import impl_hbase as hbase_alarm
from allegro.event.storage import impl_hbase as hbase_event
from allegro.storage import impl_hbase as hbase
