...
from allegro import dispatcher
...
cfg.CONF.import_opt('metering_topic', 'allegro.publisher.messaging',
                    group='publisher_rpc')
cfg.CONF.import_opt('metering_topic', 'allegro.publisher.messaging',
                    group='publisher_notifier')
cfg.CONF.import_opt('event_topic', 'allegro.publisher.messaging',
                    group='publisher_notifier')
