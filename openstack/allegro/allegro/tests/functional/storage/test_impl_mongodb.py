...
# under the License.
"""Tests for allegro/storage/impl_mongodb.py

.. note::
  In order to run the tests against another MongoDB server set the
  environment variable ALLEGRO_TEST_MONGODB_URL to point to a MongoDB
  server before running the tests.

"""

from allegro.alarm.storage import impl_mongodb as impl_mongodb_alarm
from allegro.event.storage import impl_mongodb as impl_mongodb_event
from allegro.storage import impl_mongodb
