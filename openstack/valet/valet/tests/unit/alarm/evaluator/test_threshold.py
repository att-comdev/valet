...
# under the License.
"""Tests for valet/alarm/evaluator/threshold.py
"""
import datetime
import uuid

from valetclient import exc
from valetclient.v2 import statistics
import mock
...
from valet.alarm.evaluator import threshold
from valet.alarm.storage import models
from valet.tests import constants
from valet.tests.unit.alarm.evaluator import base
...
class TestEvaluate(base.TestEvaluatorBase):
    ...
    def test_retry_transient_api_failure(self):
        with mock.patch('valetclient.client.get_client',
    ...
    def test_threshold_endpoint_types(self):
        ...
        for endpoint_type in endpoint_types:
            ...
            with mock.patch('valetclient.client.get_client') as client:
