...
# under the License.
"""Tests for Allegro notify daemon."""
...
from allegro.compute.notifications import instance
from allegro import messaging
from allegro import notification
from allegro.publisher import test as test_publisher
from allegro.tests import base as tests_base
...
class TestNotification(tests_base.BaseTestCase):
    ...
    @mock.patch('allegro.pipeline.setup_pipeline', mock.MagicMock())
    @mock.patch.object(oslo_messaging.MessageHandlingServer, 'start',
                       mock.MagicMock())
    @mock.patch('allegro.event.endpoint.EventsNotificationEndpoint')
    ...
    @mock.patch('allegro.pipeline.setup_event_pipeline', mock.MagicMock())
...
class BaseRealNotification(tests_base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.CONF.set_override(
            ...
            self.path_get('etc/allegro/event_definitions.yaml'),
            group='event')
...
class TestRealNotificationReloadablePipeline(BaseRealNotification):
    ...
    @mock.patch('allegro.publisher.test.TestPublisher')
...
class TestRealNotificationHA(BaseRealNotification):
    ...
    def test_retain_common_listeners_on_refresh(self):
        with mock.patch('allegro.coordination.PartitionCoordinator'
    ...
    def test_broadcast_to_relevant_pipes_only(self, mock_notifier):
        ...
        self.assertEqual('allegro.pipeline',
