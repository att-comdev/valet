...
import valet
from valet import alarm as valet_alarm
from valet.alarm.storage import models as alarm_models
from valet.api.controllers.v2.alarm_rules import combination
from valet.api.controllers.v2 import base
from valet.api.controllers.v2 import utils as v2_utils
from valet.api import rbac
from valet.i18n import _
...
ALARMS_RULES = extension.ExtensionManager("valet.alarm.rule")
...
class Alarm(base.Base):
    ...
    def check_alarm_actions(alarm):
        actions_schema = valet_alarm.NOTIFIER_SCHEMAS
...
def _send_notification(event, payload):
    ...
    notifier = messaging.get_notifier(transport, publisher_id="valet.api")
...
class AlarmController(rest.RestController):
    ...
    def _record_change(self, data, now, on_behalf_of=None, type=None):
        ...
        except valet.NotImplementedError:
            pass
