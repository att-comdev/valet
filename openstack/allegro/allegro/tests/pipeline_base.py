...
from allegro import publisher
from allegro.publisher import test as test_publisher
from allegro import sample
from allegro import transformer
from allegro.transformer import accumulator
from allegro.transformer import arithmetic
from allegro.transformer import conversions
...
class BasePipelineTestCase(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.useFixture(mockpatch.Patch(
            'allegro.pipeline.LOG.exception',
    ...
    @mock.patch('allegro.pipeline.LOG')
    ...
    @mock.patch('allegro.transformer.conversions.LOG')
