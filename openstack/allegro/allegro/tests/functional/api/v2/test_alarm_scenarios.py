...
from allegro.tests.functional.api import v2
...
class TestAlarms(v2.FunctionalTest,
    ...
    def test_post_alarm_trust(self):
        ...
        with mock.patch('allegro.keystone_client.get_v3_client') as client:
    ...
    @mock.patch('allegro.keystone_client.get_client')
