...
# under the License.
"""Tests for valet/storage/impl_db2.py

.. note::
  In order to run the tests against another MongoDB server set the
  environment variable VALET_TEST_DB2_URL to point to a DB2
...
from valet.alarm.storage import impl_db2 as impl_db2_alarm
from valet.event.storage import impl_db2 as impl_db2_event
from valet.storage import impl_db2
from valet.storage.mongo import utils as pymongo_utils
