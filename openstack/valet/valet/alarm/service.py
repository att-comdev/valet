...
from valet.alarm import rpc as rpc_alarm
from valet import coordination as coordination
...
cfg.CONF.import_opt('http_timeout', 'valet.service')
cfg.CONF.import_group('service_credentials', 'valet.service')
...
class AlarmService(object):
    ...
    def _load_evaluators(self):
        self.evaluators = extension.ExtensionManager(
            namespace=valet_alarm.EVALUATOR_EXTENSIONS_NAMESPACE,
            invoke_on_load=True,
...
class AlarmNotifierService(os_service.Service):
    ...
    def _handle_action(self, action, alarm_id, alarm_name, severity,
        ...
        try:
            notifier = valet_alarm.NOTIFIERS[action.scheme].obj
        except KeyError:
