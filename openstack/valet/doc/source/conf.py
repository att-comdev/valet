...
# [howto/manual]).
latex_documents = [
    ('index', 'Valet.tex', u'Valet Documentation',
...
man_pages = [
    ('index', 'valet', u'Valet Documentation',
     [u'OpenStack'], 1)
]
...
texinfo_documents = [
    ('index', 'Valet', u'Valet Documentation', u'OpenStack',
     'Valet', 'One line description of project.', 'Miscellaneous'),
]
