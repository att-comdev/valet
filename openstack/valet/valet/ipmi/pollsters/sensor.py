...
from valet.ipmi.notifications import ironic as parser
from valet.ipmi.platform import exception as ipmiexcept
from valet.ipmi.platform import ipmi_sensor
from valet import sample

CONF = cfg.CONF
CONF.import_opt('host', 'valet.service')
CONF.import_opt('polling_retry', 'valet.ipmi.pollsters',
                group='ipmi')
