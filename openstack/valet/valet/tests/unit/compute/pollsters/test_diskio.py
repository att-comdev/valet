...
from valet.compute.pollsters import disk
from valet.compute.virt import inspector as virt_inspector
import valet.tests.base as base
...
class TestBaseDiskIO(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        patch_virt = mockpatch.Patch(
            'valet.compute.virt.inspector.get_hypervisor_inspector',
        ...
        patch_inspector = mockpatch.Patch(
            'valet.compute.pollsters.BaseComputePollster.inspector',
            self.inspector)
