...
from valet.alarm.storage import impl_log as impl_log_alarm
from valet.alarm.storage import impl_sqlalchemy as impl_sqlalchemy_alarm
try:
    from valet.event.storage import impl_hbase as impl_hbase_event
except ImportError:
    impl_hbase_event = None
from valet import storage
from valet.storage import impl_log
