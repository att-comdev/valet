...
from ceilometerclient import client as allegclient
...
from allegro.alarm import rpc as rpc_alarm
from allegro import coordination as coordination
...
cfg.CONF.import_opt('http_timeout', 'allegro.service')
cfg.CONF.import_group('service_credentials', 'allegro.service')
...
class AlarmService(object):
    ...
    def _load_evaluators(self):
        self.evaluators = extension.ExtensionManager(
            namespace=allegro_alarm.EVALUATOR_EXTENSIONS_NAMESPACE,
            invoke_on_load=True,
    ...
    def _client(self):
        ...
        if not self.api_client:
            ...
            self.api_client = allegclient.get_client(2, **creds)
...
class AlarmNotifierService(os_service.Service):
    ...
    def _handle_action(self, action, alarm_id, alarm_name, severity,
        ...
        try:
            notifier = allegro_alarm.NOTIFIERS[action.scheme].obj
        except KeyError:
