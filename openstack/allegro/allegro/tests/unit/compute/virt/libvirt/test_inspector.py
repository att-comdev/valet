...
from allegro.compute.virt.libvirt import inspector as libvirt_inspector
...
class TestLibvirtInspectionWithError(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.useFixture(fixtures.MonkeyPatch(
            'allegro.compute.virt.libvirt.inspector.'
...
class TestLibvirtInitWithError(base.BaseTestCase):
    ...
    @mock.patch('allegro.compute.virt.libvirt.inspector.'
                'LibvirtInspector._get_connection',
