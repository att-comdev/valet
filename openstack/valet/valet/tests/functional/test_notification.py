...
from valet.compute.notifications import instance
from valet import messaging
from valet import notification
from valet.publisher import test as test_publisher
...
class TestNotification(tests_base.BaseTestCase):
    ...
    @mock.patch('valet.pipeline.setup_pipeline', mock.MagicMock())
    @mock.patch.object(oslo_messaging.MessageHandlingServer, 'start',
                       mock.MagicMock())
    @mock.patch('valet.event.endpoint.EventsNotificationEndpoint')
    ...
    @mock.patch('valet.pipeline.setup_event_pipeline', mock.MagicMock())
...
class BaseRealNotification(tests_base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.CONF.set_override(
            ...
            self.path_get('etc/valet/event_definitions.yaml'),
            group='event')
...
class TestRealNotificationReloadablePipeline(BaseRealNotification):
    ...
    @mock.patch('valet.publisher.test.TestPublisher')
...
class TestRealNotificationHA(BaseRealNotification):
    ...
    def test_retain_common_listeners_on_refresh(self):
        with mock.patch('valet.coordination.PartitionCoordinator'
    ...
    def test_broadcast_to_relevant_pipes_only(self, mock_notifier):
        ...
        self.assertEqual('valet.pipeline',
