...
import allegro
from allegro import alarm as allegro_alarm
from allegro.alarm.storage import models as alarm_models
from allegro.api.controllers.v2.alarm_rules import combination
from allegro.api.controllers.v2 import base
from allegro.api.controllers.v2 import utils as v2_utils
from allegro.api import rbac
...
ALARMS_RULES = extension.ExtensionManager("allegro.alarm.rule")
...
class Alarm(base.Base):
    ...
    def check_alarm_actions(alarm):
        actions_schema = allegro_alarm.NOTIFIER_SCHEMAS
...
def _send_notification(event, payload):
    ...
    notifier = messaging.get_notifier(transport, publisher_id="allegro.api")
...
class AlarmController(rest.RestController):
    ...
    def _record_change(self, data, now, on_behalf_of=None, type=None):
        ...
        except allegro.NotImplementedError:
            pass
