...
class Analyzer(object):
    ...
    def check(self, resources):
        ...
        try:
            ...
            self.log.log_error("Exception while checking instances location: %s" % ex, traceback.format_exc())
            result = False
    ...
    def are_the_same(self, res_name, level):
        ...
        try:
            ...
            self.log.log_error("Exception while verifying instances are on the same host/racks: %s" % ex, traceback.format_exc())
            return False
        return True
    ...
    def are_different(self, res_name, level):
        ...
        try:
            ...
            self.log.log_error("Exception while verifying instances are on different hosts/racks: %s" % ex, traceback.format_exc())
            return False
        return True
