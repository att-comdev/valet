...
# under the License.
"""Tests for allegro.meter.notifications
"""
import copy
import mock
import six
...
from allegro.meter import notifications
from allegro import service as allegro_service
from allegro.tests import base as test
...
MIDDLEWARE_EVENT = {
    ...
    u'publisher_id': u'allegromiddleware',
...
class TestMeterProcessing(test.BaseTestCase):
    ...
    @mock.patch('allegro.meter.notifications.LOG')
