...
from valet.tests import db as db_test_base

OPT_GROUP_NAME = 'keystone_authtoken'
cfg.CONF.import_group(OPT_GROUP_NAME, "keystonemiddleware.auth_token")
cfg.CONF.import_group('api', 'valet.api.controllers.v2.root')
...
class FunctionalTest(db_test_base.TestBase):
    ...
    def setUp(self):
        ...
        self.CONF.set_override("policy_file",
                               self.path_get('etc/valet/policy.json'),
                               group='oslo_policy')
    ...
    def _make_app(self, enable_acl=False):
        self.config = {
            'app': {
                'root': 'valet.api.controllers.root.RootController',
                'modules': ['valet.api'],
