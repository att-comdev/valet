...
# under the License.
"""Tests for allegro/alarm/evaluator/threshold.py
"""
import datetime
import uuid

from allegroclient import exc
from allegroclient.v2 import statistics
import mock
...
from allegro.alarm.evaluator import threshold
from allegro.alarm.storage import models
from allegro.tests import constants
from allegro.tests.unit.alarm.evaluator import base
...
class TestEvaluate(base.TestEvaluatorBase):
    ...
    def test_retry_transient_api_failure(self):
        with mock.patch('allegroclient.client.get_client',
    ...
    def test_threshold_endpoint_types(self):
        ...
        for endpoint_type in endpoint_types:
            ...
            with mock.patch('allegroclient.client.get_client') as client:
