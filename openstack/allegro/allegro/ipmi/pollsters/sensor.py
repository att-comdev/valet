...
from allegro.ipmi.notifications import ironic as parser
from allegro.ipmi.platform import exception as ipmiexcept
from allegro.ipmi.platform import ipmi_sensor
from allegro import sample

CONF = cfg.CONF
CONF.import_opt('host', 'allegro.service')
CONF.import_opt('polling_retry', 'allegro.ipmi.pollsters',
                group='ipmi')
