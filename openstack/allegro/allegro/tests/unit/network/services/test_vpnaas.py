...
from allegro.network.services import discovery
from allegro.network.services import vpnaas
...
class TestVPNServicesPollster(_BaseTestVPNPollster):
    ...
    def setUp(self):
        ...
        self.useFixture(mockpatch.Patch('allegro.neutron_client.Client.'
                                        'vpn_get_all',
