...
from allegro.compute.virt.hyperv import utilsv2 as utilsv2
from allegro.compute.virt import inspector
...
class TestUtilsV2(base.BaseTestCase):
    ...
    @mock.patch('allegro.compute.virt.hyperv.utilsv2.UtilsV2'
