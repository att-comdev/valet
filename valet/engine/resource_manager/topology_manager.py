...
from valet.engine.resource_manager.resource_base import Datacenter, HostGroup, Host
...
class TopologyManager(threading.Thread):
    ...
    def set_topology(self):
        ...
        status = topology.set_topology(datacenter, host_groups, hosts, self.resource.hosts)
        if status != "success":
            return False
