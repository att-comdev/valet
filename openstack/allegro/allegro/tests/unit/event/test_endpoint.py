...
from allegro.publisher import test
...
cfg.CONF.import_opt('store_events', 'allegro.notification',
                    group='notification')
...
class TestEventEndpoint(tests_base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.useFixture(mockpatch.Patch(
            'allegro.publisher.test.TestPublisher',
    ...
    def test_message_to_event_bad_event(self):
        ...
        with mock.patch("allegro.pipeline.LOG") as mock_logger:
