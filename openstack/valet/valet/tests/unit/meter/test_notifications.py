...
# under the License.
"""Tests for valet.meter.notifications
"""
import copy
import mock
import six
...
from valet.meter import notifications
from valet import service as valet_service
from valet.tests import base as test
...
MIDDLEWARE_EVENT = {
    ...
    u'publisher_id': u'valetmiddleware',
...
class TestMeterProcessing(test.BaseTestCase):
    ...
    @mock.patch('valet.meter.notifications.LOG')
