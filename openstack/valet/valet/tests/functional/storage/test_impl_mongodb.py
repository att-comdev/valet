...
# under the License.
"""Tests for valet/storage/impl_mongodb.py

.. note::
  In order to run the tests against another MongoDB server set the
  environment variable VALET_TEST_MONGODB_URL to point to a MongoDB
  server before running the tests.

"""

from valet.alarm.storage import impl_mongodb as impl_mongodb_alarm
from valet.event.storage import impl_mongodb as impl_mongodb_event
from valet.storage import impl_mongodb
