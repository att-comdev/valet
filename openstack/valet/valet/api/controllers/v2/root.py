...
from valet.api.controllers.v2 import alarms
from valet.api.controllers.v2 import capabilities
from valet.api.controllers.v2 import events
from valet.api.controllers.v2 import meters
from valet.api.controllers.v2 import query
from valet.api.controllers.v2 import resources
from valet.api.controllers.v2 import samples
from valet.i18n import _LW
...
cfg.CONF.import_opt('dispatcher', 'valet.dispatcher')
        ...
        if self._gnocchi_is_enabled is None:
            if cfg.CONF.api.gnocchi_is_enabled is not None:
                ...
                try:
                    ...
                    LOG.warn(_LW("valet-api started with gnocchi "
        ...
        if self._aodh_url is None:
            if cfg.CONF.api.aodh_is_enabled is False:
                ...
                try:
                    ...
                    LOG.warn(_LW("valet-api started with aodh enabled. "
