...
# under the License.
"""Tests for valet/storage/impl_hbase.py

.. note::
  In order to run the tests against real HBase server set the environment
  variable VALET_TEST_HBASE_URL to point to that HBase instance before
...
from valet.alarm.storage import impl_hbase as hbase_alarm
from valet.event.storage import impl_hbase as hbase_event
from valet.storage import impl_hbase as hbase
