...
class Connection(object):
    ...
    def get_resources(user=None, project=None, source=None,
        ...
        """
        raise valet.NotImplementedError('Resources not implemented')
    ...
    def get_meters(user=None, project=None, resource=None, source=None,
        ...
        :param limit: Maximum number of results to return.
        """
        raise valet.NotImplementedError('Meters not implemented')
    ...
    def get_samples(sample_filter, limit=None):
        ...
        :param limit: Maximum number of results to return.
        """
        raise valet.NotImplementedError('Samples not implemented')
    ...
    def get_meter_statistics(sample_filter, period=None, groupby=None,
        ...
        """
        raise valet.NotImplementedError('Statistics not implemented')
    ...
    def query_samples(filter_expr=None, orderby=None, limit=None):
        ...
        raise valet.NotImplementedError('Complex query for samples '
                                             'is not implemented.')
