...
MYSQL_DATA=`mktemp -d /tmp/ALLEG-MYSQL-XXXXX`
...
export ALLEGRO_TEST_MYSQL_URL="mysql+pymysql://root@localhost/template1?unix_socket=${MYSQL_DATA}/mysql.socket&charset=utf8"
