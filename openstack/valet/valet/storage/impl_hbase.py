...
import valet
from valet.storage import base
from valet.storage.hbase import base as hbase_base
from valet.storage.hbase import migration as hbase_migration
from valet.storage.hbase import utils as hbase_utils
from valet.storage import models
...
class Connection(hbase_base.Connection, base.Connection):
    ...
    def record_metering_data(self, data):
        ...
        :param data: a dictionary such as returned by
          valet.meter.meter_message_from_counter
        """
        with self.conn_pool.connection() as conn:
    ...
    def get_meters(self, user=None, project=None, resource=None, source=None,
        ...
        with self.conn_pool.connection() as conn:
            ...
            # https://bugs.launchpad.net/valet/+bug/1301371
            result = set()
    ...
    def get_meter_statistics(self, sample_filter, period=None, groupby=None,
        ...
        """
        if groupby:
            raise valet.NotImplementedError("Group by not implemented.")

        if aggregate:
            raise valet.NotImplementedError(
