...
from allegro.alarm.storage import impl_log as impl_log_alarm
from allegro.alarm.storage import impl_sqlalchemy as impl_sqlalchemy_alarm
try:
    from allegro.event.storage import impl_hbase as impl_hbase_event
except ImportError:
    impl_hbase_event = None
from allegro import storage
from allegro.storage import impl_log
