...
from valet.compute.virt.libvirt import inspector as libvirt_inspector
...
class TestLibvirtInspectionWithError(base.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.useFixture(fixtures.MonkeyPatch(
            'valet.compute.virt.libvirt.inspector.'
...
class TestLibvirtInitWithError(base.BaseTestCase):
    ...
    @mock.patch('valet.compute.virt.libvirt.inspector.'
                'LibvirtInspector._get_connection',
